...
from core.admin_utils import active_badge, color_badge
...
class TemplateAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Template Information", {"fields": ("id", "name", "category")}),
        ("Assets", {"fields": ("background_url", "preview_image")}),
        ("Configuration", {"fields": ("layout_config",)}),
        ("Management", {"fields": ("is_active", "created_by")}),
        (
            "Timestamps",
...
class CertificateAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            "Delivery Tracking",
            {"fields": ("delivery_history",), "classes": ("collapse",)},
        ),
        ("Expiration", {"fields": ("expires_at",)}),
        (
            "Timestamps",
            {"fields": ("issued_at", "updated_at"), "classes": ("collapse",)},
        ),
    )
    ...
    def delivery_badge(self, obj):
        ...
        return color_badge(
            colors.get(last_delivery.status, "gray"),
