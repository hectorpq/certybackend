...
urlpatterns = [
    ...
    path(
        "enrollments/<int:pk>/",
        EnrollmentViewSet.as_view({"delete": "destroy"}),
        name="enrollment-detail",
    ),
    path(
        "enrollments/<int:pk>/attendance/",
        EnrollmentViewSet.as_view({"patch": "attendance"}),
        name="enrollment-attendance",
    ),
    # Public invitation routes
    path(
        "invitations/<str:token>/",
        InvitationPublicView.as_view(),
    ...
    path(
        ...
        InvitationRegisterView.as_view(),
