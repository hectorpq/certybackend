    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(
                    choices=[('draft', 'Draft'), ('active', 'Active'), ('finished', 'Finished'), ('cancelled', 'Cancelled')],
                ...
                ('template_image', models.CharField(blank=True, default='', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(
                    choices=[('pending', 'Pendiente'), ('sent', 'Enviada'), ('accepted', 'Aceptada'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('certificate_sent_method', models.CharField(blank=True, default='', max_length=20)),
            ...
            options={
                ...
                'indexes': [
                    models.Index(fields=['participant', 'event'], name='enrollment_participant_event_idx'),
