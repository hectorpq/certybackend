...
class UserAdmin(admin.ModelAdmin):
    list_display = ('email', 'full_name', 'role_badge', 'is_staff', 'is_active', 'created_at')
    ...
    def password_info(self, obj):
        return "Use 'Change Password' link below to update password" if obj.id else "Password will be set after creation"
