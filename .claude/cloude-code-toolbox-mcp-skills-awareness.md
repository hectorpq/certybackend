...
_Generated: 2026-06-02T20:10:32.354Z_
...
Workspace `mcp.json` _(folder: SystemCertification)_

- **c:\Users\LENOVO\Documents\certypro\SystemCertification\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\LENOVO\.claude.json** — _File exists — no servers defined_
