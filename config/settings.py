...
EMAIL_USE_TLS = config("EMAIL_USE_TLS", default=True, cast=lambda v: str(v).lower() in ("true", "1", "yes", "") if v else True)
EMAIL_USE_SSL = config("EMAIL_USE_SSL", default=False, cast=lambda v: str(v).lower() in ("true", "1", "yes") if v else False)
